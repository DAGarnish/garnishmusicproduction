  ...
  return (
    <div className="min-h-screen bg-[#fdfdfd] font-sans selection:bg-[#E53E3E]/20">
      ...
      <section 
        ...
        style={{ backgroundImage: `url('https://www.garnishmusicproduction.com/wp-content/uploads/2022/05/Vocal-Production-cube.jpg')` }}
      >
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="text-[15px] text-[#666] leading-[1.8] mb-8 space-y-4">
                <p>
                  Record, produce, and mix a quality vocal — mic technique, editing mastery, tuning & mixing vocals and a virtual studio visit with a vocalist at work.
                </p>
                <p>
              ...
              {/* Accordions */}
              <div className="mb-12">
                <AccordionItem title="Vocal Production" isOpen={openAccordion === 0} onClick={() => toggleAccordion(0)}>
                  <ul className="list-disc pl-5 space-y-2">
                    <li>The Instrument</li>
                    <li>Signal Chains</li>
                    <li>The Performance</li>
                    <li>Editing</li>
                    <li>Backing Vocals</li>
                    <li>Mixing Considerations</li>
                    <li>Vocal Field Trip</li>
                  </ul>
                  <p className="mt-4">
