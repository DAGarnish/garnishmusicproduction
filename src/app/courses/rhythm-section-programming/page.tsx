...
export default function RhythmSectionProgrammingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfdfd] font-sans selection:bg-[#E53E3E]/20">
      ...
      <section 
        ...
        style={{ backgroundImage: `url('https://www.garnishmusicproduction.com/wp-content/uploads/2022/05/Rhythm-Section-Pro-cubed.jpg')` }}
      >
        ...
        <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-2/3">
              ...
              {/* Accordions */}
              <div className="mb-12">
                <AccordionItem title="Rhythm Section Programming" isOpen={openAccordion === 0} onClick={() => toggleAccordion(0)}>
