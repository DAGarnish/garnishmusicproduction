...
export const metadata = {
  title: "Music Production Courses Miami | Garnish",
  description: "Learn music production, DJing & songwriting in Miami. Join expert-led courses & take your skills to the next level."
};

export default function MiaHomePage() {
  const locationTitle = "Music Production Courses Miami";
  const subdomain = "mia";
