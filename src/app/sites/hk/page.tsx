...
export const metadata = {
  title: "Music Production Courses Hong Kong | Garnish",
  description: "Learn music production, DJing & songwriting in Hong Kong. Join expert-led courses & take your skills to the next level."
};

export default function HkHomePage() {
  const locationTitle = "Music Production Courses Hong Kong";
  const subdomain = "hk";
