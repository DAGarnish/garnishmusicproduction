...
export const metadata = {
  title: "Music Production Courses Los Angeles | Garnish",
  description: "Learn music production, DJing & songwriting in Los Angeles. Join expert-led courses & take your skills to the next level."
};

export default function LaHomePage() {
  const locationTitle = "Music Production Courses Los Angeles";
  const subdomain = "la";
