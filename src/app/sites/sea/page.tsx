...
export const metadata = {
  title: "Music Production Courses Seattle | Garnish",
  description: "Learn music production, DJing & songwriting in Seattle. Join expert-led courses & take your skills to the next level."
};

export default function SeaHomePage() {
  const locationTitle = "Music Production Courses Seattle";
  const subdomain = "sea";
