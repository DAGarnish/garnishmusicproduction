...
export const metadata = {
  title: "Music Production Courses Lisbon | Garnish",
  description: "Learn music production, DJing & songwriting in Lisbon. Join expert-led courses & take your skills to the next level."
};

export default function LisHomePage() {
  const locationTitle = "Music Production Courses Lisbon";
  const subdomain = "lis";
