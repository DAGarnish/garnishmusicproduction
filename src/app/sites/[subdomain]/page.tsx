...
export default async function SubdomainPage({ params }: { params: Promise<{ subdomain: string }> }) {
  ...
  const titles: Record<string, string> = {
    bh: "Music Production Courses Bournemouth",
    la: "Music Production Courses Los Angeles",
    mia: "Music Production Courses Miami",
    ny: "Music Production Courses New York",
    bcn: "Music Production Courses Barcelona",
    ber: "Music Production Courses Berlin",
    lis: "Music Production Courses Lisbon",
    hk: "Music Production Courses Hong Kong",
    tyo: "Music Production Courses Tokyo"
  };

  const locationTitle = titles[subdomain] || `Music Production Courses ${subdomain.toUpperCase()}`;
