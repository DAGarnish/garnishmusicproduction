...
export const metadata = {
  title: "Music Production Courses Nashville | Garnish",
  description: "Learn music production, DJing & songwriting in Nashville. Join expert-led courses & take your skills to the next level."
};

export default function NshHomePage() {
  const locationTitle = "Music Production Courses Nashville";
  const subdomain = "nsh";
