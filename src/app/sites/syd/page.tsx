...
export const metadata = {
  title: "Music Production Courses Sydney | Garnish",
  description: "Learn music production, DJing & songwriting in Sydney. Join expert-led courses & take your skills to the next level."
};

export default function SydHomePage() {
  const locationTitle = "Music Production Courses Sydney";
  const subdomain = "syd";
