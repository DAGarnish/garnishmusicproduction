...
export const metadata = {
  title: "Music Production Courses Tokyo | Garnish",
  description: "Learn music production, DJing & songwriting in Tokyo. Join expert-led courses & take your skills to the next level."
};

export default function TyoHomePage() {
  const locationTitle = "Music Production Courses Tokyo";
  const subdomain = "tyo";
