...
export const metadata = {
  title: "Music Production Courses San Francisco | Garnish",
  description: "Learn music production, DJing & songwriting in San Francisco. Join expert-led courses & take your skills to the next level."
};

export default function SfHomePage() {
  const locationTitle = "Music Production Courses San Francisco";
  const subdomain = "sf";
